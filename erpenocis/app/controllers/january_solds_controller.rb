class JanuarySoldsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @january_sold.save
        format.html { redirect_to january_sold_url(@january_sold), notice: "January sold was successfully created." }
  ...
  def update
    respond_to do |format|
      if @january_sold.update(january_sold_params)
        format.html { redirect_to january_sold_url(@january_sold), notice: "January sold was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to january_solds_url, notice: "January sold was successfully destroyed." }
  ...
  private
    ...
    def january_sold_params
      params.require(:january_sold).permit(:january_sold, :year)
    end
end
